...
const Product = () => {
  ...
  return productData ? (
    <div className="border-t-2 pt-10 transition-opacity ease-in duration500 opacity-100">
      {/* Product Data */}
      <div className="flex gap-0 sm:gap-12 flex-col sm:flex-row ">
        {/*---------------------------- Now for Product Images --------------------*/}
        ...
        <div className="flex-1 ">
          ...
          <div className="flex flex-col  gap-4 my-8">
            ...
            <button
              ...
              className=" bg-black text-white px-8 py-3 text-sm active:bg-gray-700 sm:w-[170px]"
            >
              ADD TO CART
            </button>
